...
| Day | Exercises |
|-----|-----------|
| D1 Squat | Goblet Squat (primer), Back Squat 5x5, Bulgarian Split Squat, Seated Leg Curl, Hanging Leg Raise |
...
| D3 Deadlift | GHD Hip Ext (primer), Deadlift 5x3, FFE Split Squat, GHD Back Ext + Med Ball, Seated Leg Curl, Hanging Leg Raise |
...
| D5 Pump | Band Pull-Apart (primer), Incline DB Press, Seated DB Shoulder Press, Cable Fly, DB Lateral Raise (4 sets), Cable Rear Delt Fly, EZ Curl SS Tricep Pushdown, Cable Crunch |
...
| Chest (DB/cable) | incline DB D4+D5, cable fly D2+D5 |
| Side delts | DB lateral D2+D4+D5 (4 sets on D5) |
